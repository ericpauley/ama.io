...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.creator'
        db.add_column(u'questions_request', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='requests_created', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.creator'
        db.delete_column(u'questions_request', 'creator_id')
    ...
    models = {
        ...
        u'questions.sessionview': {
            ...
            'user_session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'views'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['sessions.Session']"})
        },
