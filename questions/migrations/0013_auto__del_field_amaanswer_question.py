...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AMAAnswer.question'
        db.delete_column(u'questions_amaanswer', 'question_id')


    def backwards(self, orm):
        # Adding field 'AMAAnswer.question'
        db.add_column(u'questions_amaanswer', 'question',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['questions.AMAQuestion'], unique=True),
                      keep_default=False)
