...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AMASession.subtitle'
        db.alter_column(u'questions_amasession', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'AMASession.title'
        db.alter_column(u'questions_amasession', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'AMASession.desc'
        db.alter_column(u'questions_amasession', 'desc', self.gf('django.db.models.fields.TextField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'AMASession.subtitle'
        db.alter_column(u'questions_amasession', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=125))

        # Changing field 'AMASession.title'
        db.alter_column(u'questions_amasession', 'title', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'AMASession.desc'
        db.alter_column(u'questions_amasession', 'desc', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'questions.request': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requests'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['questions.AMASession']"}),
