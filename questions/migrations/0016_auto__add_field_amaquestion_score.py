...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AMAQuestion.score'
        db.add_column(u'questions_amaquestion', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AMAQuestion.score'
        db.delete_column(u'questions_amaquestion', 'score')
