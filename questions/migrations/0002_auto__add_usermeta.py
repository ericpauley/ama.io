...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'questions_usermeta', (
            ('user', self.gf('annoying.fields.AutoOneToOneField')(related_name='meta', unique=True, primary_key=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'questions', ['UserMeta'])


    def backwards(self, orm):
        # Deleting model 'UserMeta'
        db.delete_table(u'questions_usermeta')
