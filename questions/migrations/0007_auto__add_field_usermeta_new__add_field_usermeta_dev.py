...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMeta.new'
        db.add_column(u'questions_usermeta', 'new',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserMeta.dev'
        db.add_column(u'questions_usermeta', 'dev',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMeta.new'
        db.delete_column(u'questions_usermeta', 'new')

        # Deleting field 'UserMeta.dev'
        db.delete_column(u'questions_usermeta', 'dev')
    ...
    models = {
        ...
        u'questions.usermeta': {
            ...
            'dev': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
