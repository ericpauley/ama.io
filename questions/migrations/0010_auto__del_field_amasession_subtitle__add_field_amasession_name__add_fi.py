...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AMASession.subtitle'
        db.delete_column(u'questions_amasession', 'subtitle')

        # Adding field 'AMASession.name'
        db.add_column(u'questions_amasession', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'AMASession.role'
        db.add_column(u'questions_amasession', 'role',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AMASession.subtitle'
        db.add_column(u'questions_amasession', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'AMASession.name'
        db.delete_column(u'questions_amasession', 'name')

        # Deleting field 'AMASession.role'
        db.delete_column(u'questions_amasession', 'role')
