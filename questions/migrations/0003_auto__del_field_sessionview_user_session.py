...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SessionView.user_session'
        db.delete_column(u'questions_sessionview', 'user_session_id')


    def backwards(self, orm):
        # Adding field 'SessionView.user_session'
        db.add_column(u'questions_sessionview', 'user_session',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', null=True, on_delete=models.SET_NULL, to=orm['sessions.Session']),
                      keep_default=False)
