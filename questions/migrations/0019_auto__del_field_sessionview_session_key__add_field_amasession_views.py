...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SessionView.session_key'
        db.delete_column(u'questions_sessionview', 'session_key')

        # Adding field 'AMASession.views'
        db.add_column(u'questions_amasession', 'views',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SessionView.session_key'
        db.add_column(u'questions_sessionview', 'session_key',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AMASession.views'
        db.delete_column(u'questions_amasession', 'views')
    ...
    models = {
        ...
        u'questions.sessionview': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'views'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
