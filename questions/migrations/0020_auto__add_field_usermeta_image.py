...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMeta.image'
        db.add_column(u'questions_usermeta', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMeta.image'
        db.delete_column(u'questions_usermeta', 'image')
    ...
    models = {
        ...
        u'questions.amaquestion': {
            ...
            'answer': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'question'", 'unique': 'True', 'null': 'True', 'to': u"orm['questions.AMAAnswer']"}),
