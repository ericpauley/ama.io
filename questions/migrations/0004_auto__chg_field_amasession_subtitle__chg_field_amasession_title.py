...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AMASession.subtitle'
        db.alter_column(u'questions_amasession', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'AMASession.title'
        db.alter_column(u'questions_amasession', 'title', self.gf('django.db.models.fields.CharField')(max_length=30))
