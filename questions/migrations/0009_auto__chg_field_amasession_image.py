...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AMASession.image'
        db.alter_column(u'questions_amasession', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'AMASession.image'
        db.alter_column(u'questions_amasession', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))
