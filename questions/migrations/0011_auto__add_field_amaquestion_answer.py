...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AMAQuestion.answer'
        db.add_column(u'questions_amaquestion', 'answer',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['questions.AMAAnswer'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AMAQuestion.answer'
        db.delete_column(u'questions_amaquestion', 'answer_id')
    ...
    models = {
        ...
        u'questions.amaanswer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['questions.AMAQuestion']", 'unique': 'True'}),
            'response': ('django.db.models.fields.TextField', [], {})
        },
        u'questions.amaquestion': {
            'Meta': {'object_name': 'AMAQuestion'},
            'answer': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['questions.AMAAnswer']", 'unique': 'True', 'null': 'True'}),
